...
// Ignore the "#define DEFAULT_THERM_CEIL 45" in fsm-adc.h, this is where the ceiling is set // MODIFICATION
#define DEFAULT_THERM_CEIL 50  // try not to get hotter than this (in C) // MODIFICATION
...
#define BLINK_AT_RAMP_FLOOR // MODIFICATION
...
//#define USE_BIKE_FLASHER_MODE // MODIFICATION
