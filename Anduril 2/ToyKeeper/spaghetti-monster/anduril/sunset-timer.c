...
uint8_t sunset_timer_state(Event event, uint16_t arg) {
    ...
    // Enable sunset timer in simple UI
    //#ifdef USE_SIMPLE_UI // MODIFICATION
    // No timer functions in Simple UI // MODIFICATION
    //if (simple_ui_active) return EVENT_NOT_HANDLED; // MODIFICATION
    //#endif // MODIFICATION
