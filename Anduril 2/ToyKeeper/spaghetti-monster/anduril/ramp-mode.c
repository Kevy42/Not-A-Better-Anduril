...
uint8_t steady_state(Event event, uint16_t arg) {
    ...
    // 5C: shortcut to momentary mode
    // keep using 5C instead of 5H (which would also require moving sunset mode) // MODIFICATION
    // as accidental momentary mode misshaps are much much rarer here. // MODIFICATION
