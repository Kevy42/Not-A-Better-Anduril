...
uint8_t tempcheck_state(Event event, uint16_t arg) {
    ...
    // 3 clicks: previous blinky mode // MODIFICATION
        ...
        // Dont do anything if USE_BATTCHECK isnt defined (although it'd be impossible // MODIFICATION
        // to get to this state if it wasnt defined) // MODIFICATION
        #if defined(USE_BATTCHECK) // MODIFICATION
