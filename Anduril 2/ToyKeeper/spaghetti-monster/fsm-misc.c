...
#include "./anduril/aux-leds.h" // MODIFICATION
...
#define BLINK_SPEED 1100 // MODIFICATION
uint8_t blink_digit(uint8_t num) {
    ...
    for (; num>0; num--) { // MODIFICATION
        ...
        // Setting button led by altering button_led_current_state and than calling rgb_led_update() // MODIFICATION
        // as a sort of update-function because setting the button without changing button_led_current_state // MODIFICATION
        // would simply lead to rgb_led_update() setting the button state back to whatever button_led_off_mode // MODIFICATION
        // is set to. It's dirty.. i know. // MODIFICATION
        button_led_current_state = 2; // MODIFICATION
        ...
        // Solves weird bug where button gets set to low after exiting the blinking state with 1 click. // MODIFICATION
